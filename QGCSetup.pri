...
LinuxBuild {
    ...
    QMAKE_POST_LINK += && $$QMAKE_COPY $$BASEDIR/resources/icons/viam_auv2000.png $$DESTDIR
    QMAKE_POST_LINK += && $$QMAKE_COPY $$BASEDIR/resources/icons/viam_auv2000_logo_full.png $$DESTDIR
}
