...
QGCView {
    ...
    property bool   _isWebServer: false
    ...
    function _visibleWebServerBox()
    {
        if(videoSource.currentText != "Web Server Video Stream")
        {
            _isWebServer = false
        }
        else
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        GridLayout {
                            ...
                            FactTextField {
                                Layout.preferredWidth:  _comboFieldWidth
                                fact:                   QGroundControl.settingsManager.videoSettings.webServerUrl
                                visible:                _isTCP && QGroundControl.settingsManager.videoSettings.tcpUrl.visible
                            }

                            QGCLabel {
                                text:                   qsTr("HTTP URL")
                                visible:                _isWebServer
                            }
                            ...
                            FactTextField {
                                ...
                                onAccepted:
                                {
                                    _activeWebServer.setWebServerVideoHttp(qsTr(httpTextField.text))
                                }
                            }
