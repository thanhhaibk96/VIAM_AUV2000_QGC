    ...
    if(action) {
        switch(action->data().toInt()) {
            ...
            case ANALYZE:
                ...
                break;
            case MICRONTRITECH_SONARSCANNER:
                widget = new MicronTritechSonarScanner(widgetName, action, qgcApp()->toolbox()->mavlinkProtocol(),this);
                break;
        }
        if(widget) {
