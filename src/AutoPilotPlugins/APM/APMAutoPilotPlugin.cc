...
//                _controlComponent = new APMControlComponent(_vehicle, this);
//                _controlComponent->setupTriggerSignals();
//                _components.append(QVariant::fromValue((VehicleComponent*)_controlComponent));
...
QString APMAutoPilotPlugin::prerequisiteSetup(VehicleComponent* component) const
{
    ...
    if (qobject_cast<const APMFlightModesComponent*>(component)) {
        ...
        requiresAirframeCheck = true;
    } else if (qobject_cast<const APMControlComponent*>(component)) {
        requiresAirframeCheck = true;
    }
