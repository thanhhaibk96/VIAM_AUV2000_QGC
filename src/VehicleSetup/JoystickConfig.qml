                ...
                Column {
                    ...
                    Item {
                        ...
                        QGCLabel {
                            ...
                            text:   _activeVehicle.sub ? qsTr("Balast") : qsTr("Lateral")
                        }

                        Loader {
                            id:                 massShifterLoader
                            anchors.left:       massShifterLabel.right
                            ...
                            property bool mapped:           controller.massShifterAxisMapped
                            property bool reversed:         controller.massShifterAxisReversed
                        }

                        Connections {
                            target: _activeJoystick

                            onManualControl: massShifterLoader.item.axisValue = _mass_shifter*32768.0
                        }
                    }
                    ...
                    Item {
                        ...
                        QGCLabel {
                            id:     pistolLabel
                            width:  defaultTextWidth * 10
                            text:   _activeVehicle.sub ? qsTr("Pistol") : qsTr("Forward")
                        }

                        Loader {
                            id:                 pistolLoader
                            anchors.left:       pistolLabel.right
                            anchors.right:      parent.right
                            height:             ScreenTools.defaultFontPixelHeight
                            width:              100
                            sourceComponent:    axisMonitorDisplayComponent
                            ...
                            property real defaultTextWidth: ScreenTools.defaultFontPixelWidth
                            property bool mapped:           controller.pistolAxisMapped
                            property bool reversed:         controller.pistolAxisReversed
                        }

                        Connections {
                            target: _activeJoystick

                            onManualControl: pistolLoader.item.axisValue = _pistol*32768.0
                        }
                    }
                    ...
                    Item {
                        ...
                        Loader {
                            id:                 rudderLoader
                            anchors.left:       rudderLabel.right
                            anchors.right:      parent.right
                            height:             ScreenTools.defaultFontPixelHeight
                            width:              100
                            sourceComponent:    axisMonitorDisplayComponent
                            ...
                            property real defaultTextWidth: ScreenTools.defaultFontPixelWidth
                            property bool mapped:           controller.rudderAxisMapped
                            property bool reversed:         controller.rudderAxisReversed
                        }

                        Connections {
                            target: _activeJoystick

                            onManualControl: rudderLoader.item.axisValue = _rudder*32768.0
                        }
                    }
                    ...
                    Item {
                        ...
                        Loader {
                            id:                 thrusterLoader
                            anchors.left:       thrusterLabel.right
                            anchors.right:      parent.right
                            height:             ScreenTools.defaultFontPixelHeight
                            width:              100
                            sourceComponent:    axisMonitorDisplayComponent
                            ...
                            property real defaultTextWidth: ScreenTools.defaultFontPixelWidth
                            property bool mapped:           controller.thrusterAxisMapped
                            property bool reversed:         controller.thrusterAxisReversed
                        }

                        Connections {
                            target: _activeJoystick

                            onManualControl: thrusterLoader.item.axisValue = _activeJoystick.negativeThrust ? -_thruster*32768.0 : (-2*_thruster+1)*32768.0
                        }
                    }
                    ...
                    Column {
                        ...
                        Column {
                            ...
                            Column {
                                ...
                                visible: _activeVehicle.supportsThrusterModeCenterZero

                                ExclusiveGroup { id: thrusterModeExclusiveGroup }

                                QGCRadioButton {
                                    exclusiveGroup: thrusterModeExclusiveGroup
                                    text:           qsTr("Center stick is zero thruster")
                                    checked:        _activeJoystick ? _activeJoystick.thrusterMode == 0 : false

                                    onClicked: _activeJoystick.thrusterMode = 0
                                }
                                ...
                                Row {
                                    ...
                                    width:      parent.width
                                    spacing:    ScreenTools.defaultFontPixelWidth
                                    visible:    _activeJoystick ? _activeJoystick.thrusterMode == 0 : false

                                    QGCCheckBox {
                                        id:         accumulator
                                        checked:    _activeJoystick ? _activeJoystick.accumulator : false
                                        text:       qsTr("Spring loaded thruster smoothing")
                                ...
                                QGCRadioButton {
                                    exclusiveGroup: thrusterModeExclusiveGroup
                                    text:           qsTr("Full down stick is zero thruster")
                                    checked:        _activeJoystick ? _activeJoystick.thrusterMode == 1 : false

                                    onClicked: _activeJoystick.thrusterMode = 1
                                }
