...
const char*  JoystickConfigController::_imageThrusterUp =   "joystickThrottleUp.png";
const char*  JoystickConfigController::_imageThrusterDown = "joystickThrottleDown.png";
const char*  JoystickConfigController::_imageRudderLeft =      "joystickYawLeft.png";
const char*  JoystickConfigController::_imageRudderRight =     "joystickYawRight.png";
const char*  JoystickConfigController::_imageMassShifterLeft =     "joystickRollLeft.png";
const char*  JoystickConfigController::_imageMassShifterRight =    "joystickRollRight.png";
const char*  JoystickConfigController::_imagePistolUp =      "joystickPitchUp.png";
const char*  JoystickConfigController::_imagePistolDown =    "joystickPitchDown.png";
...
const JoystickConfigController::stateMachineEntry* JoystickConfigController::_getStateMachineEntry(int step)
{
    ...
    static const char* msgThrusterUp =      "Move the Thruster stick all the way up and hold it there...";
    static const char* msgThrusterDown =    "Move the Thruster stick all the way down and hold it there...";
    static const char* msgRudderLeft =         "Move the Rudder stick all the way to the left and hold it there...";
    static const char* msgRudderRight =        "Move the Rudder stick all the way to the right and hold it there...";
    static const char* msgMassShifterLeft =        "Move the Mass Shifter stick all the way to the left and hold it there...";
    static const char* msgMassShifterRight =       "Move the Mass Shifter stick all the way to the right and hold it there...";
    static const char* msgPistolDown =       "Move the Pistol stick all the way down and hold it there...";
    static const char* msgPistolUp =         "Move the Pistol stick all the way up and hold it there...";
    static const char* msgPistolCenter =     "Allow the Pistol stick to move back to center...";
    ...
    static const stateMachineEntry rgStateMachine[] = {
        ...
        { Joystick::thrusterFunction,  msgThrusterUp,      _imageThrusterUp,   &JoystickConfigController::_inputStickDetect,       NULL,                                           NULL },
        { Joystick::thrusterFunction,  msgThrusterDown,    _imageThrusterDown, &JoystickConfigController::_inputStickMin,          NULL,                                           NULL },
        { Joystick::rudderFunction,       msgRudderRight,        _imageRudderRight,     &JoystickConfigController::_inputStickDetect,       NULL,                                           NULL },
        { Joystick::rudderFunction,       msgRudderLeft,         _imageRudderLeft,      &JoystickConfigController::_inputStickMin,          NULL,                                           NULL },
        { Joystick::massShifterFunction,      msgMassShifterRight,       _imageMassShifterRight,    &JoystickConfigController::_inputStickDetect,       NULL,                                           NULL },
        { Joystick::massShifterFunction,      msgMassShifterLeft,        _imageMassShifterLeft,     &JoystickConfigController::_inputStickMin,          NULL,                                           NULL },
        { Joystick::pistolFunction,     msgPistolUp,         _imagePistolUp,      &JoystickConfigController::_inputStickDetect,       NULL,                                           NULL },
        { Joystick::pistolFunction,     msgPistolDown,       _imagePistolDown,    &JoystickConfigController::_inputStickMin,          NULL,                                           NULL },
        { Joystick::pistolFunction,     msgPistolCenter,     _imageCenter,       &JoystickConfigController::_inputCenterWait,        NULL,                                           NULL },
...
//        qDebug() << axis << _axisRawValue[axis] << endl;
    ...
    for (int chan = 0; chan<_axisCount; chan++) {
        ...
        if (chan < _axisCount) {
            ...
            switch (_rgAxisInfo[chan].function) {
                case Joystick::thrusterFunction:
                case Joystick::rudderFunction:
                case Joystick::massShifterFunction:
                case Joystick::pistolFunction:
...
bool JoystickConfigController::massShifterAxisMapped(void)
{
    return _rgFunctionAxisMapping[Joystick::massShifterFunction] != _axisNoAxis;
}

bool JoystickConfigController::pistolAxisMapped(void)
{
    return _rgFunctionAxisMapping[Joystick::pistolFunction] != _axisNoAxis;
}

bool JoystickConfigController::rudderAxisMapped(void)
{
    return _rgFunctionAxisMapping[Joystick::rudderFunction] != _axisNoAxis;
}

bool JoystickConfigController::thrusterAxisMapped(void)
{
    return _rgFunctionAxisMapping[Joystick::thrusterFunction] != _axisNoAxis;
}

bool JoystickConfigController::massShifterAxisReversed(void)
{
    if (_rgFunctionAxisMapping[Joystick::massShifterFunction] != _axisNoAxis) {
        return _rgAxisInfo[_rgFunctionAxisMapping[Joystick::massShifterFunction]].reversed;
    } else {
        return false;
    }
}

bool JoystickConfigController::pistolAxisReversed(void)
{
    if (_rgFunctionAxisMapping[Joystick::pistolFunction] != _axisNoAxis) {
        return _rgAxisInfo[_rgFunctionAxisMapping[Joystick::pistolFunction]].reversed;
    } else {
        return false;
    }
}

bool JoystickConfigController::rudderAxisReversed(void)
{
    if (_rgFunctionAxisMapping[Joystick::rudderFunction] != _axisNoAxis) {
        return _rgAxisInfo[_rgFunctionAxisMapping[Joystick::rudderFunction]].reversed;
    } else {
        return false;
    }
}

bool JoystickConfigController::thrusterAxisReversed(void)
{
    if (_rgFunctionAxisMapping[Joystick::thrusterFunction] != _axisNoAxis) {
        return _rgAxisInfo[_rgFunctionAxisMapping[Joystick::thrusterFunction]].reversed;
    } else {
        return false;
    }
}
...
{
    emit massShifterAxisMappedChanged(massShifterAxisMapped());
    emit pistolAxisMappedChanged(pistolAxisMapped());
    emit rudderAxisMappedChanged(rudderAxisMapped());
    emit thrusterAxisMappedChanged(thrusterAxisMapped());
    
    emit massShifterAxisReversedChanged(massShifterAxisReversed());
    emit pistolAxisReversedChanged(pistolAxisReversed());
    emit rudderAxisReversedChanged(rudderAxisReversed());
    emit thrusterAxisReversedChanged(thrusterAxisReversed());
