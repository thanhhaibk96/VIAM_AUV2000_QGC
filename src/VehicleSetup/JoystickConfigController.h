...
public:
    ...
    Q_PROPERTY(bool massShifterAxisMapped      READ massShifterAxisMapped     NOTIFY massShifterAxisMappedChanged)
    Q_PROPERTY(bool pistolAxisMapped     READ pistolAxisMapped    NOTIFY pistolAxisMappedChanged)
    Q_PROPERTY(bool rudderAxisMapped       READ rudderAxisMapped      NOTIFY rudderAxisMappedChanged)
    Q_PROPERTY(bool thrusterAxisMapped  READ thrusterAxisMapped NOTIFY thrusterAxisMappedChanged)

    Q_PROPERTY(int massShifterAxisReversed     READ massShifterAxisReversed       NOTIFY massShifterAxisReversedChanged)
    Q_PROPERTY(int pistolAxisReversed    READ pistolAxisReversed      NOTIFY pistolAxisReversedChanged)
    Q_PROPERTY(int rudderAxisReversed      READ rudderAxisReversed        NOTIFY rudderAxisReversedChanged)
    Q_PROPERTY(int thrusterAxisReversed READ thrusterAxisReversed   NOTIFY thrusterAxisReversedChanged)
    ...
    bool massShifterAxisMapped(void);
    bool pistolAxisMapped(void);
    bool rudderAxisMapped(void);
    bool thrusterAxisMapped(void);
    
    bool massShifterAxisReversed(void);
    bool pistolAxisReversed(void);
    bool rudderAxisReversed(void);
    bool thrusterAxisReversed(void);
...
signals:
    ...
    void massShifterAxisMappedChanged(bool mapped);
    void pistolAxisMappedChanged(bool mapped);
    void rudderAxisMappedChanged(bool mapped);
    void thrusterAxisMappedChanged(bool mapped);

    void massShifterAxisReversedChanged(bool reversed);
    void pistolAxisReversedChanged(bool reversed);
    void rudderAxisReversedChanged(bool reversed);
    void thrusterAxisReversedChanged(bool reversed);
...
private:
    ...
    static const char* _imageThrusterUp;
    static const char* _imageThrusterDown;
    static const char* _imageRudderLeft;
    static const char* _imageRudderRight;
    static const char* _imageMassShifterLeft;
    static const char* _imageMassShifterRight;
    static const char* _imagePistolUp;
    static const char* _imagePistolDown;
