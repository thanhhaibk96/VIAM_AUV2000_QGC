...
public:
    ...
    /// Test GUI
    Q_PROPERTY(CustomPlugin*   customPlugin   READ customPlugin      CONSTANT)
    ...
    /// Test Custom GUI
    Q_INVOKABLE void    testCustomButton    (void);
    Q_INVOKABLE void    testCustomButtonSend    (float _value);
    Q_INVOKABLE void    testCusSlider    (float _value);
    ...
    CustomPlugin*           customPlugin        ()  { return _customPlugin;}
