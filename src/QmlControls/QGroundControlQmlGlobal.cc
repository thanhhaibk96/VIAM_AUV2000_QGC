...
void QGroundControlQmlGlobal::setToolbox(QGCToolbox* toolbox)
{
    ...
    _customPlugin           = toolbox->customPlugin();
...
void QGroundControlQmlGlobal:: testCustomButton(void)
{
    CustomPlugin::buttonClicked();
}

void QGroundControlQmlGlobal:: testCustomButtonSend(float _value)
{
    CustomPlugin::btnSendClicked(_value);
}

void QGroundControlQmlGlobal:: testCusSlider(float _value)
{
    CustomPlugin::slideBoxTest(_value);
}
