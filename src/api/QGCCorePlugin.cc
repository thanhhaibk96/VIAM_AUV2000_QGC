...
public:
    ...
    QmlComponentInfo*   boardStatusPageWidgetInfo = nullptr;
...
QVariantList& QGCCorePlugin::instrumentPages(void)
{
    if (!_p->valuesPageWidgetInfo) {
        ...
        _p->boardStatusPageWidgetInfo = new QmlComponentInfo(tr("Boards Status"), QUrl::fromUserInput("qrc:/BoardStatusPageWidget.qml"));
        ...
        _p->instrumentPageWidgetList.append(QVariant::fromValue(_p->boardStatusPageWidgetInfo));
    }
