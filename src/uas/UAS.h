...
protected: //COMMENTS FOR TEST UNIT
    ...
    /// MANUAL CONTROL
    bool controlMassShifterManual;     ///< status flag, true if mass shifter is controlled manually
    bool controlPistolManual;    ///< status flag, true if pistol is controlled manually
    bool controlRudderManual;      ///< status flag, true if rudder is controlled manually
    bool controlThrustManual;   ///< status flag, true if thrust is controlled manually

    double manualMassShifterAngle;     ///< Mass Shifter angle set by human pilot (radians)
    double manualPistolAngle;    ///< Pistol angle set by human pilot (radians)
    double manualRudderAngle;      ///< Rudder angle set by human pilot (radians)
...
public slots:
    ...
    void setExternalControlSetpoint(float mass_shifter, float pistol, float rudder, float thrust, quint8 vlefthat, quint8 vrighthat,  quint16 buttons, int joystickMode);
