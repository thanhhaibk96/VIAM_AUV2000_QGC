...
class VehicleBoardStatusFactGroup : public FactGroup
{
    Q_OBJECT

public:
    VehicleBoardStatusFactGroup(QObject* parent = nullptr);

    Q_PROPERTY(Fact* ARM1           READ ARM1           CONSTANT)
    Q_PROPERTY(Fact* ARM2           READ ARM2           CONSTANT)
    Q_PROPERTY(Fact* VIAM_NAVI      READ VIAM_NAVI      CONSTANT)
    Q_PROPERTY(Fact* PISTOL         READ PISTOL         CONSTANT)
    Q_PROPERTY(Fact* MASS_SHIFTER   READ MASS_SHIFTER   CONSTANT)
    Q_PROPERTY(Fact* THRUSTER        READ THRUSTER        CONSTANT)

    Fact* ARM1         (void) { return &_ARM1Fact; }
    Fact* ARM2         (void) { return &_ARM2Fact; }
    Fact* VIAM_NAVI         (void) { return &_VIAM_NAVIFact; }
    Fact* PISTOL    (void) { return &_PISTOLFact; }
    Fact* MASS_SHIFTER    (void) { return &_MASS_SHIFTERFact; }
    Fact* THRUSTER    (void) { return &_THRUSTERFact; }

    static const char* _ARM1FactName;
    static const char* _ARM2FactName;
    static const char* _VIAM_NAVIFactName;
    static const char* _PISTOLFactName;
    static const char* _MASS_SHIFTERFactName;
    static const char* _THRUSTERFactName;
...
private:
    ...
    Fact        _VIAM_NAVIFact;
    Fact        _PISTOLFact;
    Fact        _MASS_SHIFTERFact;
    Fact        _THRUSTERFact;
};

class VehicleAltimeterFactGroup : public FactGroup
{
    Q_OBJECT

public:
    VehicleAltimeterFactGroup(QObject* parent = nullptr);

    Q_PROPERTY(Fact* Altimeter_inFeet           READ Altimeter_inFeet           CONSTANT)
    Q_PROPERTY(Fact* Altimeter_inMetres         READ Altimeter_inMetres         CONSTANT)
    Q_PROPERTY(Fact* Altimeter_inFathoms        READ Altimeter_inFathoms        CONSTANT)

    Fact* Altimeter_inFeet         (void) { return &_Altimeter_inFeetFact; }
    Fact* Altimeter_inMetres         (void) { return &_Altimeter_inMetresFact; }
    Fact* Altimeter_inFathoms         (void) { return &_Altimeter_inFathomsFact; }

    static const char* _Altimeter_inFeetFactName;
    static const char* _Altimeter_inMetresFactName;
    static const char* _Altimeter_inFathomsFactName;

private:
    Fact        _Altimeter_inFeetFact;
    Fact        _Altimeter_inMetresFact;
    Fact        _Altimeter_inFathomsFact;
};
...
public:
    ...
    Q_PROPERTY(Fact* voltage            READ voltage            CONSTANT) // baterryVoltage
    Q_PROPERTY(Fact* percentRemaining   READ percentRemaining   CONSTANT) // batteryPercentage
    Q_PROPERTY(Fact* mahConsumed        READ mahConsumed        CONSTANT) // batteryCapacity
    Q_PROPERTY(Fact* current            READ current            CONSTANT) // batteryCurrent
    Q_PROPERTY(Fact* totalBattery       READ totalBattery       CONSTANT) // batteryTotal
    Q_PROPERTY(Fact* usedBattery        READ usedBattery        CONSTANT) // batteryUsed
    ...
    Fact* totalBattery              (void) { return &_totalBatteryFact; }
    Fact* usedBattery               (void) { return &_usedBatteryFact; }
    ...
    static const char* _totalBatteryFactName;
    static const char* _usedBatteryFactName;
    ...
    static const int    _usedBatteryUnavailable;
    static const int    _totalBatteryUnavailable;
...
private:
    ...
    Fact            _totalBatteryFact;
    Fact            _usedBatteryFact;
    Fact            _currentFact;
...
public:
    ...
    Q_PROPERTY(bool        supportsThrusterModeCenterZero   READ supportsThrusterModeCenterZero                         CONSTANT)
...
//    Q_PROPERTY(FactGroup* battery2          READ battery2FactGroup          CONSTANT)
    Q_PROPERTY(FactGroup* battery3          READ battery3FactGroup          CONSTANT)
    Q_PROPERTY(FactGroup* wind              READ windFactGroup              CONSTANT)
    Q_PROPERTY(FactGroup* vibration         READ vibrationFactGroup         CONSTANT)
    Q_PROPERTY(FactGroup* boardstatus       READ boardStatusFactGroup       CONSTANT)
    ...
    /// My_AUV2000 Properties
    Q_PROPERTY(float sliderMassShifter    READ    sliderMassShifter    WRITE setSliderMassShifter   NOTIFY sliderMassShifterChanged)
    Q_PROPERTY(float sliderPistol    READ    sliderPistol    WRITE setSliderPistol   NOTIFY sliderPistolChanged)
    // Board Thruster Data:
    ...
    // Board Pistol Data:
    Q_PROPERTY(uint pistolLSHead    READ    pistolLSHead    NOTIFY pistolLSHeadChanged)
    Q_PROPERTY(uint pistolLSTail    READ    pistolLSTail    NOTIFY pistolLSTailChanged)
    Q_PROPERTY(float pistolPosition    READ    pistolPosition    NOTIFY pistolPositionChanged)
    Q_PROPERTY(float pistolDuty    READ    pistolDuty    NOTIFY pistolDutyChanged)
    Q_PROPERTY(float pistolTempOnChip    READ    pistolTempOnChip    NOTIFY pistolTempOnChipChanged)
    Q_PROPERTY(float pistolTempAmbient    READ    pistolTempAmbient    NOTIFY pistolTempAmbientChanged)
    Q_PROPERTY(float pistolCurrent    READ    pistolCurrent    NOTIFY pistolCurrentChanged)
    Q_PROPERTY(float pistolRSpeed    READ    pistolRSpeed    NOTIFY pistolRSpeedChanged)
    Q_PROPERTY(float pistolDSpeed    READ    pistolDSpeed    NOTIFY pistolDSpeedChanged)
    // Board Mass-Shifter Data:
    ...
    Q_INVOKABLE void sendDutyCycle_MassShifter(float _duty_cycle);
    ...
    /// CustomPlugin
    float sliderMassShifter (void) { return _sliderMassShifter;}
    void setSliderMassShifter(float _value);

    float sliderPistol (void) { return _sliderPistol;}
    void setSliderPistol(float _value);
    ...
    // Board Pistol Data:
    uint pistolLSHead (void) {return _pistolLSHead;}
    uint pistolLSTail (void) {return _pistolLSTail;}
    float pistolPosition (void) { return _pistolPosition;}
    float pistolDuty (void) { return _pistolDuty;}
    float pistolTempOnChip (void) { return _pistolTempOnChip;}
    float pistolTempAmbient (void) { return _pistolTempAmbient;}
    float pistolCurrent (void) { return _pistolCurrent;}
    float pistolRSpeed (void) { return _pistolRSpeed;}
    float pistolDSpeed (void) { return _pistolDSpeed;}
    // Board Mass-Shifter Data:
    ...
    bool supportsThrusterModeCenterZero (void) const;
...
//    FactGroup* battery2FactGroup        (void) { return &_battery2FactGroup; }
    ...
    FactGroup* boardStatusFactGroup     (void) { return &_boardStatusFactGroup; }
    ...
    Q_INVOKABLE void setAUVController(double _controller, double _enable)
    {
        sendMavCommand(MAV_COMP_ID_ALL, static_cast<MAV_CMD>(MAV_CMD_SET_AUV_CONTROLLER), true,
                       static_cast<float>(_controller),
                       static_cast<float>(_enable),
                       static_cast<float>(0),
                       static_cast<float>(0),
                       static_cast<float>(0),
                       static_cast<float>(0),
...
signals:
    // My_AUV2000 Signals
    void sliderMassShifterChanged(float _value);
    void sliderPistolChanged(float _value);
    ...
    // Board Pistol Data:
    void pistolLSHeadChanged (uint _value);
    void pistolLSTailChanged (uint _value);
    void pistolPositionChanged (float _value);
    void pistolDutyChanged (float _value);
    void pistolTempOnChipChanged (float _value);
    void pistolTempAmbientChanged (float _value);
    void pistolCurrentChanged (float _value);
    void pistolRSpeedChanged (float _value);
    void pistolDSpeedChanged (float _value);
    // Board Mass-Shifter Data:
...
private:
    // My_AUV2000 Variables
    /// CustomPlugin
    float _sliderMassShifter = 0.0f;
    float _sliderPistol = 0.0f;
    // Board Thruster Data:
    ...
    // Board Pistol Data:
    uint _pistolLSHead = 0;
    uint _pistolLSTail = 0;
    float _pistolPosition = 0.0f;
    float _pistolDuty = 0.0f;
    float _pistolTempOnChip = 0.0f;
    float _pistolTempAmbient = 0.0f;
    float _pistolCurrent = 0.0f;
    float _pistolRSpeed = 0.0f;
    float _pistolDSpeed = 0.0f;
    // Board Mass-Shifter Data:
    ...
    void _handleBatteryHeadStatus(mavlink_message_t& message);
    void _handleSysStatus(mavlink_message_t& message);
    void _handleBoardStatus(mavlink_message_t& message);
//    void _handleAltimeter(mavlink_message_t& message);
    ...
    void _handlePistol(mavlink_message_t& message);
...
//    VehicleBatteryFactGroup         _battery2FactGroup;
    ...
    VehicleBoardStatusFactGroup     _boardStatusFactGroup;
    VehicleAltimeterFactGroup       _altimeterFactGroup;
...
//    static const char* _battery2FactGroupName;
    ...
    static const char* _boardStatusFactGroupName;
    static const char* _altimeterFactGroupName;
